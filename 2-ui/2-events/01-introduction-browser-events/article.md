...
There are more properties. Many of them depend on the event type: keyboard events have one set of properties and pointer events have another one. We'll study them later as we move on to the details of different events.
